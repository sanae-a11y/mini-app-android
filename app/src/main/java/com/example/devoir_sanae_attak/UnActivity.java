...
public class UnActivity extends AppCompatActivity {
    ImageView un ,lire,back;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_un);
        un = (ImageView) findViewById(R.id.one);
        lire = (ImageView) findViewById(R.id.lire);
        ...
        lire.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MediaPlayer media = MediaPlayer.create(getApplicationContext(),R.raw.a1);
                media.start();
